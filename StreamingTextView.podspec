#
# Be sure to run `pod lib lint StreamingTextView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'StreamingTextView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of StreamingTextView.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'StreamingTextView' => ['StreamingTextView/Assets/*.png']
  # }
